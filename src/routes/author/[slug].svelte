  ...
  <div class="author">
    ...
    <div class="social-icons">
      {#each author.social as social}
        {#if social['email']}
          <a class="social-icon" href={'mailto: ' + social['email']} target="_blank"
        ...
        {:else if social['facebook']}
          <a class="social-icon" href={social['facebook']} target="_blank">
        ...
        {:else if social['twitter']}
          <a class="social-icon" href={social['twitter']} target="_blank"
        ...
        {:else if social['website']}
          <a class="social-icon" href={social['website']} target="_blank">
            <svg viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
              <path
