...
<div class="share-list">
  ...
  <div class="share-icon-list">
    <a href={`https://www.facebook.com/sharer/sharer.php?u=${pageUrl}`} target="_blank">
      <svg class="nav-icon" width="25" height="25" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
        <path
          fill-rule="evenodd"
          clip-rule="evenodd"
    ...
    <a href={`https://twitter.com/share?url=${pageUrl}`} target="_blank">
      <svg class="nav-icon" width="25" height="25" viewBox="0 0 36 36" xmlns="http://www.w3.org/2000/svg">
        <path
    ...
    <a href={`https://lineit.line.me/share/ui?url=${pageUrl}`} target="_blank">
      <svg class="nav-icon" width="25" height="23.81" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
        <path
