...
<svelte:head>
  <title>關於我們 - DD Story Hub 融數基地</title>
  <link rel="canonical" href="https://www.ddstoryhub.com/about" />
  <meta
    name="description"
    content="DD Story Hub 融數基地是因為喜歡研究數位敘事及資料新聞，而聚集在一起的夥伴，期待能夠透過不同的敘事方式，放大故事影響力。"
  />
  <meta name="author" content="ddstoryhub.com" />
  <meta property="og:title" content="關於我們 - DD Story Hub 融數基地" />
  <meta property="og:type" content="website" />
  <meta property="og:url" content="https://www.ddstoryhub.com/about" />
  ...
  <meta name="twitter:title" content="關於我們 - DD Story Hub 融數基地" />
  <meta
          ...
          <div class="author-meta">
            <div class="name-social">
              ...
              <div class="social-icons">
                {#each social as s}
                  {#if s['email']}
                    <a class="social-icon" href={'mailto: ' + s['email']} target="_blank"
                    ...
                    >
                  {:else if s['facebook']}
                    <a class="social-icon" href={s['facebook']} target="_blank">
                  ...
                  {:else if s['twitter']}
                    <a class="social-icon" href={s['twitter']} target="_blank"
                  ...
                  {:else if s['website']}
                    <a class="social-icon" href={s['website']} target="_blank">
                      <svg viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
                        <path
